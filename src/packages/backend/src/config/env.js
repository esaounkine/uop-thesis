...
export const openAlexMaxPerSecond = Number(process.env.OPENALEX_MAX_PER_SECOND ?? 10);
...
export const semanticScholarMaxPerSecond = Number(process.env.SEMANTIC_SCHOLAR_MAX_PER_SECOND ?? 1);
