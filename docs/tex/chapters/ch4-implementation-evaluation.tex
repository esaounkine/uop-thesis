...
The backend performs the retrieval as a background job, because collecting data takes time, especially for sources with low throughput and authors with many publications.
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=10cm]{include/fig-providers-diagram}
